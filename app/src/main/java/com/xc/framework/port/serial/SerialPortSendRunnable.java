...
public abstract class SerialPortSendRunnable extends XCRunnable {
     ...
     * @date 2020/3/8
     */
    public SerialPortSendRunnable(byte[] sendDatas, int what, boolean isWaitReceive, SerialPortParam serialPortParam, SerialPort serialPort, SerialPortReceiveThread serialPortReceiveThread) {
        ...
        this.serialPortReceiveThread = serialPortReceiveThread;
    }
    ...
    private void waitReceive() throws InterruptedException {
        ...
        do {
            byte[] receiveDatas = serialPortReceiveThread.getReceive();
