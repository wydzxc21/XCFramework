...
public abstract class SerialPortReceiveThread extends XCThread {
    ...
    public SerialPortReceiveThread(SerialPortParam mSerialPortParam, SerialPort mSerialPort) {
        init(mSerialPortParam.getReceiveFrameHeads(), mSerialPort);
    }

    /**
     * @param receiveFrameHeads 接收帧头
     * @param mSerialPort       串口工具
     * @author ZhangXuanChen
     * @date 2020/3/8
     */
    public SerialPortReceiveThread(byte[] receiveFrameHeads, SerialPort mSerialPort) {
        init(receiveFrameHeads, mSerialPort);
    }
     ...
     * Description：init
     */
    private void init(byte[] receiveFrameHeads, SerialPort mSerialPort) {
    ...
    private void readDatas() {
        byte[] readDatas = mSerialPort.readSerialPort();
