package com.xc.framework.socket.client.sdk;


import com.xc.framework.socket.client.impl.client.ManagerHolder;
 ...
 * Description：OkSocket-一款轻量级的Socket通讯框架,可以提供单工,双工的TCP通讯.
